...
app.use(log4js.connectLogger(log, {
  ...
  nolog: ['\\/$', '^/images/.', '^/css/.', '^/js/.', '^/webfonts/.'], // don't log request for images, css, etc. nor root requests (AWS health check spams our logs)
}));

// Favicon middleware
app.use(favicon(path.join(__dirname, 'assets', 'images', 'logonew1.png')));
